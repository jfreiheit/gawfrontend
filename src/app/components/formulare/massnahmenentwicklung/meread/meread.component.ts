...
@Component({
  selector: 'app-meread',
  templateUrl: './meread.component.html',
  styleUrls: ['./meread.component.css']
})
export class MEreadComponent implements OnInit {
  form: FormGroup;
  formular: Formulare;
  ...
  onSubmit() {
    ...
    this.formular.title = this.massnahmenentwicklungTitle;
